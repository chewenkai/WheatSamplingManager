...
class GalleryActivity : AppCompatActivity() {
    ...
    private var autoGeneratedSheetID = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        autoGeneratedSheetID = intent.getStringExtra(Constant.AUTO_GENERATED_SHEETID)
        imagesFiles = MediaManager().getLatestCameraFiles(this, autoGeneratedSheetID)
