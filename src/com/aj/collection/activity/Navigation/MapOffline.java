package com.aj.collection.activity.Navigation;
...
public class MapOffline extends Activity implements MKOfflineMapListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemBarTintManager.setStatusBarTint(MapOffline.this, Color.argb(0, 59, 59, 59));//跑步界面黑色背景
    ...
    private void initView() {
        ...
        ListAdapter hAdapter = (ListAdapter) new ArrayAdapter<String>(this,
                R.layout.listview_map_offline, hotCities);
        hotCityList.setAdapter(hAdapter);
//        hotCityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//            @Override
//            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//               String citycod= ((TextView)view).getText().toString().substring(((TextView)view).getText().toString().indexOf("("),
//                        ((TextView)view).getText().toString().indexOf(")"));
//            }
//        });
        ...
        ListAdapter aAdapter = (ListAdapter) new ArrayAdapter<String>(this,
                R.layout.listview_map_offline, allCities);
...
//        cl.setVisibility(View.VISIBLE);
    ...
    public void search(View view) {
        ...
        if (records == null || records.size() != 1){
            Toast.makeText(this, "找不到您输入的城市" , Toast.LENGTH_SHORT)
                    .show();
            return;
        }
        ...
        Toast.makeText(this, "开始下载离线地图:" + cityNameView
    ...
    public void onGetOfflineMapState(int type, int state) {
        switch (type) {
            ...
            case MKOfflineMap.TYPE_NEW_OFFLINE:
                // 有新离线地图安装
                Log.d("MapOffline", String.format("add offlinemap num:%d", state));
                break;
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(MapOffline.this,
                    R.layout.listview_map_offline_localmap_list, null);
            initViewItem(view, e);
            return view;
        }
        ...
        void initViewItem(View view, final MKOLUpdateElement e) {
            ...
            display.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(MapOffline.this, MapActivity.class);
