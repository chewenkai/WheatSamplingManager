...
import com.aj.collection.activity.Calendar_View;
...
import com.aj.collection.activity.tools.L;
...
import com.aj.collection.activity.ui.widget.AutoCompleteEditText;
...
//                LinearLayout item_layout = (LinearLayout) mContext.getLayoutInflater().inflate(R.layout.item_layout, null);//第一层的布局文件 块条目 包括两部分 分别是名 和内容
...
//            Toast.makeText(mContext.getApplicationContext(), "解析json失败", Toast.LENGTH_LONG).show();
//        }
//    }
