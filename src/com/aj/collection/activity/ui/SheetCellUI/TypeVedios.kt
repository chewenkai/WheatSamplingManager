...
class TypeVedios(var mContext: Context, var sheetCell: SheetCell, val autoGeneratedSheetID:String): CellBaseAttributes() {
    ...
    init {
        ...
        gallaryAdaper = GallaryAdaper(mContext,MediaManager().getLatestVedioFiles(File(Util.getMediaFolder(mContext)+File.separator+autoGeneratedSheetID + File.separator +
                cell_name!!.text.toString())), autoGeneratedSheetID, cell_name!!.text.toString())
    ...
    class GallaryAdaper(var mContext: Context, private val photoFiles: ArrayList<File>,
                        val autoGeneratedSheetID:String, val cell_name: String) : RecyclerView.Adapter<GallaryAdaper.ViewHolder>() {
        ...
        fun updateUI() {
            ...
            this.photoFiles.addAll(MediaManager().getLatestVedioFiles(
