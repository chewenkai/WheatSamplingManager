                        ...
                        when (currentMode) {
                            MODE_TEMPLATE -> {
                                ...
                                val samplingtable = SAMPLINGTABLE(null, taskID, templetID, sheetList[i][0].cell.get_cell_value(),
                                        ...
                                        latitudeStr, longitudeStr, locationType, sheetList[i][0].autoGeneratedSheetID, false)
        ...
        try {
            ...
            for (i in sheetCellList.indices) {
                if (sheetCellList[i].cell_copyable == SheetProtocol().True) {
                    ...
                    val sheetCellUI = SheetCellUI(this@SheetActivity, sheetCellUIList[i].sheetCell, autoGeneratedSheetID)
                    ...
                    val newMediaPath = File(Util.getMediaFolder(mContext) + File.separator + autoGeneratedSheetID + File.separator +
