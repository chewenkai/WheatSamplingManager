 ...
 */
class SheetCellUI(var context: Context, var sheetCell: SheetCell, var taskinfo: TASKINFO?,
                  var autoGeneratedSheetID:String) {
    var cell: CellBaseAttributes = TypeEditText(context, sheetCell)
    init {
        when (sheetCell.cell_type){
            SheetProtocol().TYPE_SERIAL_NUMBER -> cell = TypeSerialNumber(context, sheetCell, taskinfo)
