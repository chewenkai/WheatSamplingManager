 ...
 */
class TypePhotos(var mContext: Context, var sheetCell: SheetCell, autoGeneratedSheetID: String) : CellBaseAttributes() {
    var autoGeneratedSheetID = ""

    init {
        this.autoGeneratedSheetID = autoGeneratedSheetID
    }
    ...
    override fun setFilledContent(content: String) {
        ...
        // 添加到老照片列表
        olderMediaFiles.clear()
        olderMediaFiles.addAll(photoFiles)
    }
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (Constant.NEW_PHOTO_BROADCAST_ACT == action) {
                ...
                if (cellIdentity == this@TypePhotos.cellIdentity) {
                    ...
                    // 判断新照片
                    loop@ for (file in gallaryAdaper!!.photoFiles) {
    ...
    init {
        ...
        takePhotoButton!!.onClick {
            ...
            if (location_info_type == BDLocation.TypeGpsLocation ||
                ...
                (mContext as SheetActivity).startActivityForResult(intent, SheetActivity.REQUESTCODEFORPICTURE)
            } else
     ...
     */
    class GallaryAdaper(var mContext: Context, val photoFiles: ArrayList<File>,
